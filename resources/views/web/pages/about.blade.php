...
@section('content')
    <div class="page-wrapper">
        ...
        <section class="about-one">
            <img src="{{ asset('assets/images/shapes/about-leaf-1-1.png') }}" alt="" class="about-one__shape-1">
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-lg-6">
                        <img src="{{ asset('assets/images/resources/about-1-1.png') }}" class="img-fluid" alt="">
                    </div><!-- /.col-md-12 -->
                    <div class="col-md-12 col-lg-6">
        ...
        <section class="video-one jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% 50%">
            <img src="{{ asset('assets/images/backgrounds/video-bg-1-1.jpg') }}" alt="" class="jarallax-img">
        ...
        <section class="team-one">
            <img src="{{ asset('assets/images/shapes/team-shape-1.png') }}" alt="" class="team-one__shape-1">
            <img src="{{ asset('assets/images/shapes/team-shape-2.png') }}" alt="" class="team-one__shape-2">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card">
                            <div class="team-card__image">
                                <img src="{{ asset('assets/images/team/team-1-1.png') }}" alt="">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card">
                            <div class="team-card__image">
                                <img src="{{ asset('assets/images/team/team-1-2.png') }}" alt="">
                            </div><!-- /.team-card__image -->
                            <div class="team-card__content">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card">
                            <div class="team-card__image">
                                <img src="{{ asset('assets/images/team/team-1-3.png') }}" alt="">
                            </div><!-- /.team-card__image -->
                            <div class="team-card__content">
                                <h3>Peter Ramsey</h3>
                                <div class="team-card__social">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="team-card">
                            <div class="team-card__image">
                                <img src="{{ asset('assets/images/team/team-1-4.png') }}" alt="">
                            </div><!-- /.team-card__image -->
                            <div class="team-card__content">
                                <h3>Eric Miller</h3>
                                <div class="team-card__social">
                    ...
                    <div>
                        <div class="testimonials-one__single">
                            ...
                            <div class="testimonials-one__content">
                                <p>I was very impresed by the osfins service lorem ipsum is simply free text used by copy
                                    typing
